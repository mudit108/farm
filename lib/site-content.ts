 ...
 */
import { INSTALLMENT_DUE_DAYS, installmentFeeInr } from "@/lib/demo-data";
...
export const harvestFlow = [
  ...
  { title: "Your choice applied", body: "Delivered raw, milled into atta, or sold on your behalf." },
...
const rawFaqs: Omit<Faq, "id">[] = [
  ...
  { cat: "season", q: "How do you know what's right for your soil?", a: "We have sent samples from our fields for laboratory soil testing. Until the results come back, RAJ 1482 — bred for Rajasthan's soil and climate — is a well-matched choice rather than a guess. Once the results arrive they will guide our crop and nutrient decisions, and we will share what we learn with members." },
  { cat: "season", q: "Is the farm organic?", a: "Not yet, and we won't claim otherwise. Fertiliser is applied based on soil testing and each crop's actual needs. This is our first season, and we are actively working toward certified organic farming, aiming to reach it next season. We will update this the moment certification is achieved." },
  ...
  { cat: "season", q: "What happens if the crop fails?", a: "Agriculture is seasonal and subject to weather, soil, pests, water availability and other natural factors. We do not guarantee yield or returns. Our team follows agronomic best practice to manage risk, and any crop-loss handling is governed by your membership agreement." },

  { cat: "plot", q: "What do I receive with my membership?", a: "A dedicated allocation of farm plots (1, 3 or 6), wheat cultivation with soil-tested, responsible fertiliser management by our team, 24×7 camera access to your plots, regular farm updates, crop-cycle tracking, and eligibility to visit the farm." },
  ...
  { cat: "plot", q: "Can I visit my farm?", a: "Yes, subject to prior scheduling, farm conditions, safety requirements and operational availability. Requests are raised from your dashboard, which shows your exact plot numbers — so you will know precisely which plots are yours when you arrive." },
  ...
  { cat: "harvest", q: "What are my options for the harvest?", a: "Three: (1) we deliver the raw harvest to your home, with delivery charged separately; (2) we mill it into fresh atta and deliver that; or (3) we sell it on the market on your behalf and send you the proceeds. For either delivery option, you can also receive it in monthly instalments of a size you choose — for example 40 kg a month — set from your dashboard's Harvest Preference." },
  ...
  { cat: "money", q: "Can I pay in two parts?", a: "Yes, on all three plans. Pay 50% to reserve and your plots are locked immediately, exactly as with a full payment. The remaining 50% is due {DUE_DAYS} days later. A small convenience fee applies to the deposit: {FEE1} for Kothi, {FEE3} for Annakosh or Mahabhandar." },
  ...
  { cat: "trust", q: "How does the CCTV work?", a: "Each plot is covered by one or more field cameras, and camera access is a member benefit that begins once sowing starts. Live streaming to member dashboards is being rolled out; until it is live for your plot, you will see recent photos there instead — clearly labelled as photos, never presented as a live feed. The camera system is managed by our team, and its credentials are never shared with members." },
  { cat: "trust", q: "Can I watch the farm any time?", a: "Your dashboard is open 24×7 and shows the most recent photo from your plot's camera whenever you check. Full live video is being rolled out, and we will update this as it becomes available for your plot." },
